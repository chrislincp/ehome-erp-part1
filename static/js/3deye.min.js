(function(e) {
	e.fn.extend({
		vc3dEye:function(t) {
			new e.vc3dEye(this,t);return
		}
	});
		e.vc3dEye=function(t,n){function h(e,t) {
			u=e;a=t.imagePath;i=t.totalImages;c=t.imageExtension
		}
		function p() {
		...
		function d(t){
			if(o-t>25){
				...
				o=t;r=++r>i?1:r;e(u).css("background-image","url("+a+r+"."+c+")")
			}
		}
		function v(){
			var t=a+"1."+c;
			e(u).css("background-image","url("+t+")");e("<img/>").attr("src",t).load(function(){
				e(u).height(this.height).width(this.width)
			});
			for(var n=2;n<=i;n++){
				t=a+n+"."+c;e(u).append("<img src='"+t+"' style='display:none;'>");
		...
		function m(){
			e("html").append("<style type='text/css'>.onLoadingDiv{background-color:#00FF00;alpha:0;opacity:0.5;text-align:center;font-size:2em;font:color:#000000;}</style>")
		}
